...
function SendPaidTransaction(
    ...
    const setValue = async () => {
        ...
        try {
            ...
            console.log("4 - Sending userOp", userOp)
    ...
    return (
        <div>
            <button onClick={setValue} disabled={!(!!props.smartAccount && userValue)}> Set Value (Paid) </button>
            {' '}
            <label>Number</label>
            {' '}
            <input
...
export default SendPaidTransaction;